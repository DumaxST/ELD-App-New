...
import elegirRemolque from "./screens/principalScreen/perfilVehiculo/elegirRemolque";
...
const MainStackNavigator = ({ handleLogout }) => (
  <Stack.Navigator>
    ...
    <Stack.Screen name="ElegirRemolque" component={elegirRemolque} options={{ drawerLabel: null, drawerIcon: null, headerShown: false }}/>
