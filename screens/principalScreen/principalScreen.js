    ...
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        <View style={styles.controlContainer}>
          ...
          <View style={styles.stateButtons}>
            ...
            <TouchableOpacity
              style={[
                styles.stateButton,
                selected === 'Sleeping' && styles.selectedButton,
              ]}
              onPress={() => handleStateChange('Sleeping')}
            >
              <Text style={[styles.buttonText, selected === 'Sleeping' && styles.selectedText]}>
                Sleeping
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.stateButton,
                selected === 'Driving' && styles.selectedButton,
              ]}
              onPress={() => handleStateChange('Driving')}
            >
              <Text style={[styles.buttonText, selected === 'Driving' && styles.selectedText]}>
                Driving
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            <TouchableOpacity
              style={[
                styles.stateButton,
                selected === 'Custom1' && styles.selectedButton,
              ]}
              onPress={() => handleStateChange('Custom1')}
            >
              <Text style={[styles.buttonText, selected === 'Custom1' && styles.selectedText]}>
                Custom1
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.stateButton,
                selected === 'Custom2' && styles.selectedButton,
              ]}
              onPress={() => handleStateChange('Custom2')}
            >
              <Text style={[styles.buttonText, selected === 'Custom2' && styles.selectedText]}>
                Custom2
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.centerButton,
                selected === 'Center' && styles.selectedButton,
              ]}
              onPress={() => handleStateChange('Center')}
            >
              <Text style={[styles.buttonText, selected === 'Center' && styles.selectedText]}>
                Center
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.graphsContainer}>
          {/* Gráficas improvisadas */}
          {/* Puedes agregar tus componentes de gráficos aquí */}
          <Text>Gráficas</Text>
        </View>
      </View>
    </View>
