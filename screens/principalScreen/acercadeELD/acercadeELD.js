    ...
    function header() {
      ...
      <Ionicons name={"arrow-back-circle-outline"} onPress={() => navigation.pop()} size={27} color="white" />
        <Text style={{ ...Fonts.whiteColor22SemiBold }}>
          {"    " + languageModule.lang(language,'aboutELD')}
        </Text>
      </View>
      );
    }
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{ marginTop: Sizes.fixPadding * 3.0 }}>
            {profileOptionShort({
              ...
              option: ["ELD", "35843094748108"],
            })}
            {profileOptionShort({
              icon: require("../../../assets/images/icons/bluetooth-success.png"),
              option: ["Firmware", languageModule.lang(language,'noAvailable')],
            })}
            {profileOptionShort({
              icon: require("../../../assets/images/icons/bluetooth-success.png"),
              option: [languageModule.lang(language, 'macAddress'), languageModule.lang(language,'noAvailable')],
            })}
            {profileOptionShort({
              icon: require("../../../assets/images/icons/bluetooth-success.png"),
              option: ["Versión", "132"],
